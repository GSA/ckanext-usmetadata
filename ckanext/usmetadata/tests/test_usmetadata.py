...
class TestUsmetadataPlugin(object):
    ...
    def setup(self):
        ...
        self.package_dict = call_action_api(
            self.app, 'package_create', apikey=self.sysadmin.get('apikey'),
            name='my_package_000',
            title='my package',
    ...
    def test_resource_create(self):
        ...
        print "second"
        resource_dict = call_action_api(
            self.app, 'resource_create', apikey=self.sysadmin.get('apikey'),
    ...
    def test_package_update(self):
        ...
        assert package_dict['name'] == 'my_package'
        package_dict_update = call_action_api(
            self.app, 'package_update', apikey=self.sysadmin.get('apikey'),
            name='my_package',
